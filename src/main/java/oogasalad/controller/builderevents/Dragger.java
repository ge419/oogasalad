 ...
 * the dragger can know the correct dragging bounds to prevent the node from dragging outside
 * of the parent.</p>
 *
...
public class Dragger implements DraggerAPI {
   ...
   * by this transformation, and then update our instance variables for our scene offset
   * in use in dragging.</p>
   * @param parent parent node of the draggable object
   */
  ...
  /**
   * <p>Sets the maximum translation based on the current maximum width and height of the parent pane
  ...
  /**
   * Given a coordinate in the coordinate space of the scene, convert it to a coordinate relative
   * to the parent node.
   * @param sceneValueX
   * @param sceneValueY
   ...
   * <p>If the area is within bounds, the given defaultXTranslation and defaultYTranslation are returned back to the
   * user in a dimension object.</p>
   * <p>If the area is not within bounds, the result inside of the dimension object will be the
   * edge in the parent node closest to the mouse event (dictated by myMinTranslate and myMaxTranslate
   * </p>
  ...
  /**
   * <p> Checks if the mouse click is within the bounds of the right and bottom sides of the parent pane</p>
   * @param resultHolder
   * @param currentMouseX
   * @param currentMouseY
  ...
  private void checkRightAndBottomSides(Dimension resultHolder, double currentMouseX, double currentMouseY, double defaultTranslatedX, double defaultTranslatedY){
    resultHolder.setSize(
        (myMaxWidthAtStartOfDrag < currentMouseX + myNodeWidth) ? myMaxTranslate.getWidth() : defaultTranslatedX,
        (myMaxHeightAtStartOfDrag < currentMouseY + myNodeHeight) ? myMaxTranslate.getHeight() : defaultTranslatedY
    );
  }

  /**
   * <p>Checks if the mouse click is within the bounds of the left and top sides of the parent pane.</p>
   * @param resultHolder
   * @param currentMouseX
   * @param currentMouseY
   * @param defaultTranslatedX
