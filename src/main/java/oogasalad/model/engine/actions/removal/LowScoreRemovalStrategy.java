...
/**
 * Concrete implementation of the {@link PlayerRemovalStrategy}
 * Used by Actions to remove players (ex. {@link CheckAndRemovePlayerAction})
 *
 * @Author Jay Yoon
 */
public class LowScoreRemovalStrategy implements PlayerRemovalStrategy {
  ...
  /**
   * method that removes the list of players that satisfy removal condition
   * updates GameHolder and returns list of removed players
   * <p>
   *   checks if player score is lower than given bound
   *   if satisfied player is removed from the game
   * </p>*
