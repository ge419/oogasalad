...
/**
 * Interface used by BoardInfo implementations that keep track of images on the board and
 * the size of the board. Implementing this makes the board info mutable
 * @author Trevon Helm
 */
