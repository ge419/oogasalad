...
/**
 * A custom Event type used to track events related to ViewTiles in the builder.
 * These events are fired when events related to tiles happen, and filters/handlers can
 * be used to run methods when these events happen
 * Example Usage:
 * Firing an event:
 * TileEvent event = new TileEvent(TileEvent.DELETE_TILE, tile);
 * myPane.fireEvent(event);
 * Calling a method when an event is fired:
 * myPane.addEventFilter(TileEvent.DELETE_TILE, this::deleteTile);
...
public class TileEvent extends Event {
    ...
    /**
     * Creates a new instance of a TileEvent, with the specified type.
     * This behaves like any other JavaFX event and can be fired and
     * handled in the same way
     * @param eventType EventType such as DELETE_TILE or SET_NEXT_TILE that specifies what type of TileEvent should be created
     * @param tile ViewTile
     */
