 ...
 * a double is required from the user via user input. This consists
 * of one labeled double spinner for the user to input a double.
 * Example Usage:
 * VBox form = new VBox();
 * DoubleParameterStrategy strategy = new DoubleParameterStrategy(myDoubleAttribute, myDoubleMetadata);
...
public class DoubleParameterStrategy implements ParameterStrategy, BuilderUtility {
    ...
    /**
     * Creates an instance of DoubleParameterStrategy
     * Can be used to display form data to a user for a double,
     * validate the input, save to an attribute, and access
     * the corresponding DoubleAttribute and DoubleMetadata
